...
COLOR_BACKGROUND = "#FF0077"
COLOR_FOREGROUND_MAIN_WINDOW = "#8F1E73"
COLOR_LABELS_BORDERS = "#3C1386" 
COLOR_INPUT_BACKGROUND = "#BB0A65"
COLOR_INPUT_TEXT = "#FF00BF"
COLOR_LOG_TEXT = "#AAAAAA"
COLOR_BUTTON_BACKGROUND = "#FF25DB"
COLOR_BUTTON_TEXT = "#E61F93"
COLOR_BUTTON_BORDER = "#FF009D"


COLOR_ERROR_BORDER = "#FF0000"


APP_IMAGE_URL = "https://k.top4top.io/p_36066jw3d1.png"
...
class AttackThread(QThread):
    ...
    def run(self):
        ...
        """
        self.log_signal.emit(" femboy hit ACTIVATED! TARGET LOCKED! \n")
        if self.use_proxy:
        ...
        if self.running:
            self.log_signal.emit("\n Femboy FINISHED. TARGET ELIMINATED. ")
    ...
    def stop(self):
        ...
        """
        self.running = False
        self.log_signal.emit("\n femboy HALTED BY USER.")


class MainWindow(QMainWindow):
    """
    The main application window for the femboy hit simulated DDoS tool.
    Provides an enhanced user interface with more visual feedback and controls.
    """
    def __init__(self):
        super().__init__()
        self.setWindowTitle(" femboy hit by batman/aligamm")
        ...
        self.credit_label = QLabel("by Batman/aligamm")
        self.credit_label.setAlignment(Qt.AlignCenter)
        self.credit_label.setStyleSheet(f"color: {COLOR_LABELS_BORDERS}; font-size: 1px;")
        ...
        self.start_button = QPushButton("LAUNCH femboy hit")
    ...
    def load_image_from_url(self, url):
        ...
        try:
            ...
            if not pixmap.isNull():
                ...
                self.log_message(" IMAGE LOADED! boykisser IS READY!")
            else:
    ...
    def start_attack(self):
        ...
        self.log_message(" Launching femboy hit ...")
    ...
    def stop_attack(self):
        ...
        self.progress_bar.setValue(0)
        self.log_message(" femboy stopped.")
